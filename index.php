...
<html id="html-container">
	...
	<nav class="nav-bar">
			<ul>
				...
				<li><a href="BushhillPark/bh_home.php" >Bush Hill Park</a>
					<ul>
						<li><a href="index.php?BushhillParkMeetingTimeImg=show">Meeting times</a></li>
					</ul>
				</li>

				<li><a href="leavalley/lv_home.php" >Lea Valley</a>
					<ul>
				...
				<li><a href="JubileePark/jp_home.php" >Jubilee Park</a>
					<ul>
						<li><a href="index.php?JubileeParkMeetingTimes=show">Meeting times</a></li>
					</ul>
				</li>

				<li><a href="polish/pol_home.php" >Polish</a>
					<ul>
